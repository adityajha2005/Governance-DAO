...
export const ProjectCard: React.FC<ProjectCardProps> = ({ 
  ...
  <div className="bg-white rounded-xl border border-black overflow-hidden shadow-sm hover:shadow-md transition-all group">
    <div className={`h-40 bg-gradient-to-br ${gradient} relative p-6`}>
      ...
      <div className="w-12 h-12 bg-white rounded-lg shadow-sm flex items-center justify-center font-bold text-black text-lg border border-black/50">
        {initial}
      </div>
    </div>
    <div className="p-6">
      ...
      <p className="text-sm text-black mb-6 line-clamp-2 leading-relaxed">
        {desc}
      </p>
      <div className="flex justify-between items-center pt-4 border-t border-white">
        <div>
          <span className="text-[9px] text-black uppercase font-bold tracking-widest block mb-0.5">
            Grant Total
          </span>
