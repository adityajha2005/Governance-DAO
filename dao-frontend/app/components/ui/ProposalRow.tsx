...
export const ProposalRow: React.FC<ProposalRowProps> = ({ 
  ...
  <div className="p-6 flex items-center justify-between hover:bg-gray-50 transition-colors cursor-pointer group">
    <div className="flex items-center space-x-6">
      <div className="w-10 h-10 rounded bg-gray-50 flex items-center justify-center font-bold text-gray-400 text-xs border border-gray-100">
        #{id}
      </div>
      <div className="min-w-0">
        ...
        <div className="text-[12px] text-gray-500 font-medium mt-1 uppercase tracking-tight">
          {meta}
        </div>
      </div>
    </div>
